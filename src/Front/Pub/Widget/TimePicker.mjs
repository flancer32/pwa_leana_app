...
export default function Fl32_Leana_Front_Pub_Widget_TimePicker(spec) {
    /** @type {Fl32_Leana_Front_Pub_Widget_TimePicker_Entry} */
    const entry = spec.Fl32_Leana_Front_Pub_Widget_TimePicker_Entry$;
    return {
        template,
        components: {
