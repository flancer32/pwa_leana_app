/**
 * Frontend gate to 'employee/workTime/generate' service.
 */
export default function (spec) {
    ...
    const URL = `https://${config.web.urlBase}/api/${DEF.API_ROUTE_EMPL_WTIME_GENERATE}`;

    /**
     * @param {Fl32_Leana_Shared_Service_Route_Employee_WorkTime_Generate_Request} data
     * @return {Promise<Fl32_Leana_Shared_Service_Route_Employee_WorkTime_Generate_Response|TeqFw_Core_App_Front_Gate_Response_Error>}
     * @exports Fl32_Leana_Front_Gate_Employee_WorkTime_Generate
     */
    async function Fl32_Leana_Front_Gate_Employee_WorkTime_Generate(data) {
        try {
    ...
    return Fl32_Leana_Front_Gate_Employee_WorkTime_Generate;
