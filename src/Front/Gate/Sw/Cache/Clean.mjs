/**
 * Frontend gate to  request service worker state ('/sw/cache/clean' pseudo route).
 */
export default function (spec) {
    ...
    /** @type {typeof Fl32_Leana_Shared_Service_Route_Sw_Cache_Clean_Response} */
    const Response = spec['Fl32_Leana_Shared_Service_Route_Sw_Cache_Clean#Response'];
     ...
     * @return {Promise<Fl32_Leana_Shared_Service_Route_Sw_Cache_Clean_Response|TeqFw_Core_App_Front_Gate_Response_Error>}
     * @exports Fl32_Leana_Front_Gate_Sw_Cache_Clean
     */
    async function Fl32_Leana_Front_Gate_Sw_Cache_Clean(data) {
        try {
    ...
    return Fl32_Leana_Front_Gate_Sw_Cache_Clean;
}
