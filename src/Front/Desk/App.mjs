...
export default function Fl32_Leana_Front_Desk_App(spec) {
    ...
    const compRouteDev = spec.Fl32_Leana_Front_Desk_Route_Dev$;
    const compRouteEmployees = spec.Fl32_Leana_Front_Desk_Route_Employees$;
    const compRouteServices = spec.Fl32_Leana_Front_Desk_Route_Services$;
    const compWidgetTaskPreview = spec.Fl32_Leana_Front_Desk_Widget_Task_Preview$;
    const state = spec.Fl32_Leana_Front_Desk_State$;
    // const stateCalendar = spec.Fl32_Leana_Front_Desk_App_State_Calendar$;
