...
export default class Fl32_Leana_Front_Desk_Util_Convert_Api2Ui {
     ...
     */
    constructor(spec) {
        this.ApiTask = spec['Fl32_Leana_Shared_Service_Data_Task#'];
    ...
    /**
     *
     * @param {Fl32_Leana_Shared_Service_Data_Task} apiTask
     * @param {Object.<Number, Fl32_Leana_Shared_Service_Data_Employee>} apiEmployees
