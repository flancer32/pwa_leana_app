...
export default function Fl32_Leana_Front_Desk_Widget_Calendar_ActionBar(spec) {
    const Bar = spec['Fl32_Leana_Front_Desk_Widget_Action_Api#Bar'];
    const Item = spec['Fl32_Leana_Front_Desk_Widget_Action_Api#Item'];
    const wgActionBar = spec.Fl32_Leana_Front_Desk_Widget_Action_Bar$;    // singleton
    const wgSetDate = spec.Fl32_Leana_Front_Desk_Widget_Calendar_SetDate$;    // singleton
    const wgTaskEdit = spec.Fl32_Leana_Front_Desk_Widget_Task_Edit$;    // singleton
